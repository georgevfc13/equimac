...
<div style="margin-bottom:24px">
  <h3 style="font-size:18px;margin:0 0 16px;font-weight:700">Kardex</h3>
  
  <!-- ENTRADAS -->
  <div class="card pad" style="margin-bottom:14px">
    <div style="display:flex;align-items:center;gap:8px;margin-bottom:16px">
      <div style="width:24px;height:24px;background:rgba(34,197,94,.2);border-radius:8px;display:flex;align-items:center;justify-content:center;font-weight:700;color:rgb(34,197,94);font-size:14px">↓</div>
  ...
  <div class="card pad">
    <div style="display:flex;align-items:center;gap:8px;margin-bottom:16px">
      <div style="width:24px;height:24px;background:rgba(239,68,68,.2);border-radius:8px;display:flex;align-items:center;justify-content:center;font-weight:700;color:rgb(239,68,68);font-size:14px">↑</div>
