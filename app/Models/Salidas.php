...
final class Salidas
{
    ...
    public function create(int $inventarioId, string $codigo, string $quienRecibio, string $quienEntrego, int $cantidadUsada, ?string $fechaSalida = null, ?string $horaSalida = null, ?string $observaciones = null): void
    {
        $sql = 'INSERT INTO salidas (inventario_id, codigo, quien_recibio, quien_entrego, cantidad_usada, fecha_salida, hora_salida, observaciones)
                VALUES (:inv_id, :codigo, :quien_recibio, :quien_entrego, :cantidad_usada, :fecha_salida, :hora_salida, :observaciones)';
